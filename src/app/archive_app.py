"""Archived group-stage Streamlit views for the World Cup AI Simulator."""
...
# Allow running Streamlit pages from project root
...
page = os.environ.get("WORLD_CUP_ARCHIVE_PAGE", "Live Scorecard")
